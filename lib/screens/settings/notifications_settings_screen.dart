...
class _NotificationsSettingsScreenState
    ...
    try {
      ...
      setState(() {
        ...
        _messageNotificationsEnabled =
            prefs.getBool('message_notifications_enabled') ?? true;
        _friendRequestNotificationsEnabled =
            prefs.getBool('friend_request_notifications_enabled') ?? true;
        _randomChatNotificationsEnabled =
            prefs.getBool('random_chat_notifications_enabled') ?? true;
      });
    } catch (e) {
  ...
  Future<void> _saveNotificationSettings() async {
    try {
      ...
      await prefs.setBool(
          'message_notifications_enabled', _messageNotificationsEnabled);
      await prefs.setBool('friend_request_notifications_enabled',
          _friendRequestNotificationsEnabled);
      await prefs.setBool(
          'random_chat_notifications_enabled', _randomChatNotificationsEnabled);
            ...
            gradient: LinearGradient(
              ...
              colors: [
                (iconColor ?? AppColors.primary)
                    .withOpacity(enabled ? 0.2 : 0.1),
                (iconColor ?? AppColors.primary)
                    .withOpacity(enabled ? 0.1 : 0.05),
              ],
            ),
