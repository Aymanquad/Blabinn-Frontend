  ...
  Future<void> _loadStorageData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _totalStorage =
            _storageData.values.fold(0, (sum, value) => sum + value);
      });
    } catch (e) {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () => Navigator.pop(context, true),
            child:
                const Text('Clear Media', style: TextStyle(color: Colors.red)),
          ),
        ],
      ),
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildActionButton(
                    title: 'Clear Cache',
                    subtitle:
                        'Free up ${_formatBytes(_storageData['Cache'] ?? 0)} of temporary files',
                  ...
                  _buildActionButton(
                    ...
                    subtitle:
                        'Delete downloaded images, videos, and audio files',
