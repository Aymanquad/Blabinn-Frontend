class AdConfig {
  ...
  // // Real App IDs for production
  // static const String androidAppId =
  //     'ca-app-pub-5160335418378680~2708057766'; // Real App ID
  // static const String iosAppId =
  //     'ca-app-pub-5160335418378680~2656870690'; // Real App ID

  // // Test Banner Ad Unit IDs for development
  // static const String androidBannerAdUnitId =
  //     'ca-app-pub-5160335418378680/3442612402'; // Real Banner Ad Unit ID
  // static const String iosBannerAdUnitId =
  //     'ca-app-pub-5160335418378680/2002280482'; // Real Banner Ad Unit ID

  // // Test Interstitial Ad Unit IDs for development
  // static const String androidInterstitialAdUnitId =
  //     'ca-app-pub-5160335418378680/6987105743'; // Real Interstitial Ad Unit ID
  // static const String iosInterstitialAdUnitId =
