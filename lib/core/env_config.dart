...
class EnvConfig {
  ...
  // ===== AYMAN PC CONFIG =====
  // API Configuration
  static const String apiBaseUrlAndroid = 'http://192.168.1.6:3000';  // Updated to correct IP
  static const String apiBaseUrlIos = 'http://localhost:3000';
  static const String apiBaseUrlWeb = 'http://localhost:3000';
  static const String apiBaseUrlDefault = 'http://localhost:3000';
  ...
  static const String wsUrlAndroid = 'http://192.168.1.6:3000';  // Updated to correct IP
  ...
  // Physical Device IP (for Android physical devices)
  static const String physicalDeviceIp = '192.168.1.6';  // Updated to correct IP
